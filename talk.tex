...
\begin{frame}{History Independence is a Security Guarantee}
...
\textbf{A History-Independent Algorithm:} At any given moment, if $S$ is the current set of balls, use allocation $\texttt{Greedy}(S)$.
...
\begin{frame}{Analyzing History-Independent Greedy}
  ...
  \begin{center}
    ...
    \pause
    \begin{itemize}
    \item The algorithm is history independent \hspace{0.3em}{\color{blue}\ding{51}}  \pause 
    \item The overload is $O(\log \log n)$ \hspace{0.3em}{\color{blue}\ding{51}} \pause 
    \item But what about the recourse?
    \end{itemize}
\end{frame}
