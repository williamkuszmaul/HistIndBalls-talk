...
\usepackage{verbatim}
\usetikzlibrary{arrows,shapes,arrows.meta,calc,decorations.pathreplacing}
...
\begin{tikzpicture}[scale=0.85]
  ...
  \node[font=\scriptsize, below] at (1.0, -0.1) {Round $0$};
  ...
  \node[font=\scriptsize, below] at (4.3, -0.1) {Round $1$};
  ...
  \node[font=\scriptsize, below] at (7.6, -0.1) {Round $2$};
