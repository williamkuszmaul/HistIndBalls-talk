...
\def\biny{0}
\def\ballsize{0.52cm}
\def\ballspacing{0.58}

% World positions (centered better)
\def\xL{-5.0}
\def\xR{1.2}
...
\newcommand{\TwoWorldFigure}[2]{% extra tikz for world0 balls, world1 balls
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,scale=0.95]
    % separator line
    \draw[densely dotted, line width=1.2pt, black!50] (0,-0.5) -- (0,3.5);

    % bins for both worlds
    \DrawBinsAt{\xL}
    \DrawBinsAt{\xR}

    % S_0 and S_1 labels above each world
    \node[font=\small, anchor=south] at ({\xL+1.5*(\binw+\bingap)+0.5*\binw},2.9) {$S_0 = x_1,x_2,x_3,x_4,\ldots$};
    \node[font=\small, anchor=south] at ({\xR+1.5*(\binw+\bingap)+0.5*\binw},2.9) {$S_1 = x_1,x_2,x_3,x_4,{\color{blue}x^{*}},\ldots$};

    % world labels below bins
    \node[font=\normalsize\bfseries] at ({\xL+1.5*(\binw+\bingap)+0.5*\binw},-0.55) {World 0};
    \node[font=\normalsize\bfseries] at ({\xR+1.5*(\binw+\bingap)+0.5*\binw},-0.55) {World 1};
...
% \begin{frame}
%   \title{Faster Data Structures via History Independence}  
...
%
%  \begin{tabular}{ccc}
%Michael A. Bender &Alex Conway & Mart\'in Farach-Colton \\
%\small Stony Brook & \small  VMware & \small  Rutgers  \\
%\includegraphics[height = 2cm]{michael} & \includegraphics[height = 2cm]{alex} & \includegraphics[height = 2cm]{martin} \\
%& & \\
%
%
%Hanna Koml\'os & \color{blue} William Kuszmaul & Nicole Wein   \\
%
%\small  Rutgers &\small   MIT & \small  DIMACS  \\
%
%\includegraphics[height = 2cm]{hanna} & \includegraphics[height = 2cm]{bill} & \includegraphics[height = 2cm]{nicole}
%  \end{tabular}
%\end{frame}
...
\TwoWorldFigure{ }{ }
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 11 (PDF p11): x1 chooses among 4 bins (draw arrows to all) ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_1$};
  \foreach \b in {1,2,3,4}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_1$};
  \foreach \b in {1,2,3,4}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}
...
\TwoWorldFigure{
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_1$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_1$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}
...
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{RedBallStyle}{$x_1$}
}{
  \BallInBin{1.2}{1}{1}{RedBallStyle}{$x_1$}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 14 (PDF p14): label forgotten (unlabeled ball in bin 1) ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_2$};
  \foreach \b in {1,2}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_2$};
  \foreach \b in {1,2}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}
...
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \BallInBin{-5.0}{2}{1}{RedBallStyle}{$x_2$}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{RedBallStyle}{$x_2$}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 17 (PDF p17): forget label, two unlabeled balls in bins 1 and 2 ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \BallInBin{-5.0}{2}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_3$};
  \foreach \b in {1,2}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_3$};
  \foreach \b in {1,2}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
...
% --- Frame 19 (PDF p19): x3 placed (world0 only), world1 blank in original ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \BallInBin{-5.0}{2}{1}{}{}
  \BallInBin{-5.0}{2}{2}{RedBallStyle}{$x_3$}
}{
  % world1 intentionally empty to match original slide
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 20 (PDF p20): forget label; world0 has bin1:1, bin2:2; world1 empty ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
% --- Frame 21 (PDF p21): x4 chooses among 2 bins (2 and 4), world1 empty ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \BallInBin{-5.0}{2}{1}{}{}
  \BallInBin{-5.0}{2}{2}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_4$};
  \foreach \b in {2,4}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  % world1 intentionally empty
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 22 (PDF p22): x4 placed in bin4 (world0), world1 empty ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  \BallInBin{-5.0}{2}{1}{}{}
  \BallInBin{-5.0}{2}{2}{}{}
  \BallInBin{-5.0}{4}{1}{RedBallStyle}{$x_4$}
}{
  % world1 empty
}
\vspace{1mm}
...
% --- Frame 23 (PDF p23): forget label; world0 bins [1,2,0,1], world1 empty ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\TwoWorldFigure{
  ...
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{4}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,BlueOutlineStyle] (bR) at (3.1,2.7) {$x^{*}$};
  \foreach \bb in {3,4}{\draw[->,blue,line width=1.1pt] (bR) -- (RT\bb);}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}
...
\TwoWorldFigure{
  ...
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueOutlineStyle}{$x^{*}$}
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}

% --- Frame 26 (PDF p26): forget label; x* becomes filled blue in world1 bin4 ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
  ...
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{} % filled blue
}
\vspace{1mm}
{\small \textbf{World 0:} Insert balls from $S_0$ \hspace{1cm} \textbf{World 1:} Insert balls from $S_1 = S_0 \cup \{x^{*}\}$}
\end{frame}
...
\TwoWorldFigure{
  ...
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
}
\vspace{1mm}
{\small \textbf{Future insertions:} (1) No recourse}
\end{frame}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{2}{2}{}{}
  \BallInBin{-5.0}{4}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_5$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  ...
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_5$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{Future insertions:} (1) No recourse}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{2}{1}{}{}
  \BallInBin{-5.0}{2}{2}{}{}
  \BallInBin{-5.0}{3}{1}{RedBallStyle}{$x_5$}
  \BallInBin{-5.0}{4}{1}{}{}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{3}{1}{RedBallStyle}{$x_5$}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
}
\vspace{1mm}
...
% --- Frame 30 (PDF p30): forget label; same occupancy ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{3}{1}{}{}
  \BallInBin{-5.0}{4}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_6$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  ...
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_6$};
  \foreach \b in {1,3}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{Future insertions:} (1) No recourse}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{2}{2}{}{}
  \BallInBin{-5.0}{3}{1}{}{}
  \BallInBin{-5.0}{3}{2}{RedBallStyle}{$x_6$}
  \BallInBin{-5.0}{4}{1}{}{}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  \BallInBin{1.2}{2}{2}{}{}
  \BallInBin{1.2}{3}{1}{}{}
  \BallInBin{1.2}{3}{2}{RedBallStyle}{$x_6$}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
}
\vspace{1mm}
...
% --- Frame 33 (PDF p33): forget label; bin3 now has 2 balls ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{3}{2}{}{}
  \BallInBin{-5.0}{4}{1}{}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aL) at (-3.1,2.7) {$x_7$};
  \foreach \b in {2,3}{\draw[->,red,line width=1.1pt] (aL) -- (LT\b);}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  \BallInBin{1.2}{2}{2}{}{}
  ...
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
  \node[circle,draw,minimum size=0.55cm,inner sep=0pt,RedBallStyle] (aR) at (3.1,2.7) {$x_7$};
  \foreach \b in {2,3}{\draw[->,red,line width=1.1pt] (aR) -- (RT\b);}
}
\vspace{1mm}
{\small \textbf{Future insertions:} (1) No recourse}
\end{frame}
...
\TwoWorldFigure{
  ...
  \BallInBin{-5.0}{3}{1}{}{}
  \BallInBin{-5.0}{3}{2}{}{}
  \BallInBin{-5.0}{3}{3}{RedBallStyle}{$x_7$}
  \BallInBin{-5.0}{4}{1}{}{}
}{
  \BallInBin{1.2}{1}{1}{}{}
  \BallInBin{1.2}{2}{1}{}{}
  ...
  \BallInBin{1.2}{3}{1}{}{}
  \BallInBin{1.2}{3}{2}{}{}
  \BallInBin{1.2}{3}{3}{RedBallStyle}{$x_7$}
  \BallInBin{1.2}{4}{1}{}{}
  \BallInBin{1.2}{4}{2}{BlueFillStyle}{}
}
\vspace{1mm}
...
% --- Frame 36 (PDF p36): label forgotten; bin3 has 4 balls (matches picture) ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
% --- Frame 37 (PDF p37): add option 2 (Recourse) ---
\begin{frame}
\TopSeq
\TwoWorldFigure{
  \BallInBin{-5.0}{1}{1}{}{}
...
\vspace{1mm}
{\small \textbf{Future insertions:} (1) No recourse \quad (2) Recourse}
\end{frame}
